# SDDL2 Opcode Reference (Auto-generated)

This document is generated from `src/openzl/compress/graphs/sddl2/sddl2_opcodes.def`.
Do not edit by hand.
...
### SEGMENT (0x000C)
Segment creation operations

| Mnemonic                     | Opcode   | Params | Description                                                      |
| ---------------------------- | -------- | ------ | ---------------------------------------------------------------- |
| `segment.create_unspecified` | `0x0001` | `-`    | Pop I64 (size_bytes), create unspecified segment                 |
| `segment.create_tagged`      | `0x0002` | `-`    | Pop I64 (element_count), pop Type, pop Tag, create typed segment |

<!-- END SDDL2_OPCODE_LIST -->
